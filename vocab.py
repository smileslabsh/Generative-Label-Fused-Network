...
annotations = {
    ...
    'f30k_part': ['train_caps.txt', 'dev_caps.txt'],
    'my_data': ['train_caps.txt', 'dev_caps.txt'],
    'f30k_new': ['train_caps.txt', 'dev_caps.txt']
}
...
class Vocabulary(object):
    ...
    def add_word(self, word):
        if word not in self.word2idx:
            ...
            self.word2idx[word.encode('utf8')] = self.idx
            self.idx2word[self.idx] = word.encode('utf8')
            self.idx += 1
